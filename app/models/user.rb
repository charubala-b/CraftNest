class User < ApplicationRecord
  ...
  # Both users can place bids (freelancer use case)
  has_many :bids, dependent: :destroy

  # For contracts (as freelancer and client)
  has_many :contracts, class_name: 'Contract', foreign_key: :freelancer_id, dependent: :destroy
